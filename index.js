...
const requestSharedNameSpace = createNamespace('NoNApiNameSpace');
...
// If running in development mode, start the server on port 5000, else export handler for lambda
